...
| -------------------------------- | ------------------------------------------------------------- | ------------------------------------------- |
| [**Creating**](creating-data.md) | `pd.DataFrame()`, `read_csv()`, `read_excel()`, `from_dict()` | Create a new DataFrame from scratch or file |
...
| **Modifying Columns**            | `assign()`, column arithmetic, `rename()`                     | Create or rename columns                    |
