...
1. Read [Basics](basics.md) to understand themes, `hue`, and DataFrame-friendly plotting.
2. Continue with [Distribution](distribution.md), [Categorical](categorical.md), and [Relational](relational.md) for core EDA use cases.
3. Use [Regression](regression.md) and [Matrix](matrix.md) when you need model-oriented or multivariate exploration.
