...
Key point: Descriptive statistics is for describing and summarizing what the data looks like. Once you start generalizing beyond the observed data, you have moved into inferential statistics.
...
If you are using this module to prepare for later inference and modeling, focus on this order:

1. variable type recognition
2. distribution shape and spread
3. missingness and outlier structure
4. pairwise relationships before testing or modeling

Tip: Many later "modeling mistakes" are already visible during descriptive analysis if you look carefully enough.
