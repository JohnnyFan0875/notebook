...
??? quote "What does "true zero" mean?"
    ...
    > - In practice, this means ratio comparisons only make sense when a true zero exists. You can say someone earns twice as much, but you should not say `20°C` is twice as hot as `10°C`.
