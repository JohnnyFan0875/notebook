...
- 如果你想把 `pandas` 的 missing data 處理拆開來看，可以接著看 [pandas missing-data](/home/johnny_fan/project/notebook/docs/data-science/python-foundations/pandas/missing-data.md)。
- 如果你想把 Seaborn 常見圖表拆開來看，可以接著看 [Seaborn Basics](/home/johnny_fan/project/notebook/docs/data-science/data-manipulation-and-eda/visualization/seaborn/basics.md)。
