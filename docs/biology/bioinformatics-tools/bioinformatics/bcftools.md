...
**BCFtools** is a set of command-line tools for manipulating [VCF](../../genomics/sequencing-and-analysis/file-format/vcf.md) (Variant Call Format) and BCF (Binary Call Format) files, which are used to store genetic variant information. It is commonly used in genomics pipelines for variant calling, filtering, statistics, and format conversion.
