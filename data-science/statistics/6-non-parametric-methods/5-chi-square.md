# 5. Categorical Association: Chi-Square Tests
...
> 📌 **No parametric equivalent** in the strict sense — Chi-square is its own family. It answers: "Are these two categorical variables associated, or are they independent?"

---

## 5.1 Two Types of Chi-Square Tests
...
> 💡 **Intuition**: If variables are independent, observed frequencies should be close to expected frequencies. Large deviations → large χ² → evidence of association.
...
> ⚠️ Cramér's V thresholds vary by table size (number of rows/columns). Interpret with context.

---

## 5.4 Assumptions & When to Use Fisher's Exact Test
...
## 5.5 Chi-Square Goodness of Fit
...
> 💡 **Standardized residuals** tell you *which cells* are driving the association. Cells with |residual| > 2 are notably over- or under-represented compared to what independence would predict.
