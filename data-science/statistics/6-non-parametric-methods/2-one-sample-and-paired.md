...
> 📌 **Parametric equivalents**: One-sample t-test → Sign Test or Wilcoxon Signed-Rank Test; Paired t-test → Wilcoxon Signed-Rank Test.

---

## 2.1 The Sign Test (符號檢定)
...
> ⚠️ The Sign Test throws away information about the *size* of differences. Use the Wilcoxon Signed-Rank Test if the magnitude matters — it almost always does.

---

## 2.2 Wilcoxon Signed-Rank Test (Wilcoxon 符號等級檢定)
...
> 💡 **Always report effect size alongside the p-value.** Statistical significance tells you the effect probably exists; effect size tells you if it matters.  
> p-value 告訴你效果是否存在，effect size 告訴你效果是否重要，兩者都要報告。

---

## 2.3 Choosing Between Sign Test and Wilcoxon Signed-Rank
...
> ⚠️ Independence of observations is still required — paired tests handle within-subject dependence, but different pairs must be independent from each other.
