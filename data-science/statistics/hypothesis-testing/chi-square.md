...
- **Difference from independence test:** Both use contingency tables, but

  - Independence test: Are two variables associated in one population?
  - Homogeneity test: Are distributions of one categorical variable the same across different populations?
