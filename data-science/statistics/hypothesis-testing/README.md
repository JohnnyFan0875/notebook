...
| --------------------------------- | ----------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------- |
| **Normality**                     | [Shapiro–Wilk](./normality-tests.md#shapirowilk-test)             | Tests if data come from a normal distribution.                        | General test for small to moderate samples. |
|                                   | [Kolmogorov–Smirnov](./normality-tests.md#kolmogorovsmirnov-test) | Tests goodness-of-fit to normal distribution.                         | Alternative for larger samples.             |
| **Equal variances (homogeneity)** | [Levene’s](./variance-tests.md#levenes-test)                      | Tests equality of variances across groups; robust to non-normal data. | General-purpose test.                       |
|                                   | [Bartlett’s](./variance-tests.md#bartletts-test)                  | Tests equality of variances (assumes normality).                      | Use only for normal data.                   |
|                                   | [Brown–Forsythe](./variance-tests.md#brownforsythe-test)          | Modified Levene’s using medians; robust to outliers.                  | Best for skewed or heteroscedastic data.    |
