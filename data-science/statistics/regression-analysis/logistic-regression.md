...
This note focuses on **statistical modeling and interpretation**: log-odds, odds ratios, GLM framing, and how to explain coefficients. If you want the machine-learning baseline workflow, go to [Machine Learning: Logistic Regression](../../machine-learning/supervised-learning/classification/logistic-regression.md). If you want formula API, p-values, and package-specific output, use [Statsmodels: Logistic Regression](../../machine-learning/packages/statsmodels/logistic-regression.md).
