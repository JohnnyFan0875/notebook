...
This note covers the data structure unique to survival analysis: event times, censoring, and the `time` plus `event` representation. For experiment-design terminology such as factors, units, and confounding, see [Core Concepts & Terminology](../experimental-design/core-concepts.md).
