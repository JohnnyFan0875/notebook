...
這篇偏重 **R 工作流**：`DBI`、HTTP / JSON、其他統計軟體格式，以及 R 在匯入後常見的型別與 label 問題。若你主要使用 Python，可對照 [Python: Importing Data from Common File Formats](../python-foundations/importing-data.md)。
...
- [Ingestion](../data-engineering/ingestion.md)
