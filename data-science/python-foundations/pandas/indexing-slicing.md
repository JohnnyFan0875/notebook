...
This page focuses on dataframe-style selection with labels, boolean filters, and `.loc[]` / `.iloc[]`. For raw array indexing where axes and broadcasting are the main concerns, see [NumPy Indexing and Slicing](../numpy/indexing-slicing.md).
