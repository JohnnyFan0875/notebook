...
This note focuses on **pandas datetime columns and indexes**: `pd.to_datetime`, `.dt`, `DatetimeIndex`, filtering, and resampling. If you need the lower-level Python standard-library view, see [Datetime Module](../datetime.md). If you want the equivalent workflow in R, see [Date and Time in R](../../r-foundations/datetime.md).
