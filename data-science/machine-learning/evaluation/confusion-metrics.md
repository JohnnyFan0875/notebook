...
A **confusion matrix** is used to evaluate the performance of a [classification](../supervised-learning/classification/README.md) model. It summarizes prediction results by comparing actual labels vs. predicted labels.
...
- **Accuracy** can be misleading in [**imbalanced datasets**](class-imbalance.md). Example: If 95% of data belongs to one class, predicting everything as that class yields 95% accuracy but poor performance.
...
- **Precision vs Recall tradeoff**: higher precision reduces false positives, higher recall reduces false negatives. See also [Classification Thresholds and Calibration](classification-thresholds-and-calibration.md).
