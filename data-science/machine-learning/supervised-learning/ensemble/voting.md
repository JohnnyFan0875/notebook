...
- **VotingClassifier** for [classification](../classification/README.md) tasks.
- **VotingRegressor** for [regression](../regression/README.md) tasks.
...
- Use `voting='soft'` when base models can output class probabilities (better for [imbalanced](../../evaluation/class-imbalance.md) data).
- Make sure hyperparameters in the grid follow the format: `classifier__parameter`.
- Diversity of models (tree, [SVM](../classification/svm.md), [KNN](../classification/knn.md), etc.) often improves ensemble performance.
...
- Consider scaling features, especially when combining distance-based models like [KNN](../classification/knn.md) with linear models.
