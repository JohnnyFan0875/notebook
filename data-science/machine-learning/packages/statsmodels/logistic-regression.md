...
This note focuses on **statsmodels usage**: formula syntax, `summary()`, pseudo R², p-values, and diagnostics. For the underlying model interpretation, see [Statistics: Logistic Regression](../../../statistics/regression-analysis/logistic-regression.md). For the scikit-learn classification workflow, see [Machine Learning: Logistic Regression](../../supervised-learning/classification/logistic-regression.md).
...
- [Logistic regression](../../supervised-learning/classification/logistic-regression.md) estimates the probability that `y=1` given `x`.
...
- Applying a [threshold](../../evaluation/classification-thresholds-and-calibration.md) (commonly 0.5) converts probabilities into class predictions.
...
- Mosaic plot visualizes [classification](../../supervised-learning/classification/README.md) results.
...
> For [logistic regression](../../supervised-learning/classification/logistic-regression.md), deviance and pseudo R² are often more informative than [MSE](../../evaluation/mse-rmse.md).
...
- Use `logit("y ~ x", data=df).fit()` for [logistic regression](../../supervised-learning/classification/logistic-regression.md) in statsmodels.
...
- [Logistic regression](../../supervised-learning/classification/logistic-regression.md) is best for binary outcomes, but can be extended to multinomial or ordinal cases with other `statsmodels` functions.
