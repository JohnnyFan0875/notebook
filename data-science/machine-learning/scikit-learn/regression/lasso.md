...
Lasso Regression (Least Absolute Shrinkage and Selection Operator) is a linear regression model that includes **L1 regularization**. It penalizes the absolute values of coefficients, which can shrink some coefficients to zero, effectively performing **feature selection**.
...
- `best_score`: Best cross-validation performance.
