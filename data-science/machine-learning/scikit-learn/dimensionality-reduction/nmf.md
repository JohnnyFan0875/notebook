...
- Compared to PCA, NMF ensures components and weights are non-negative, making them easier to interpret as “parts-based” representations.
...
- NMF + cosine similarity is widely used in **topic modeling** and **text clustering**.
