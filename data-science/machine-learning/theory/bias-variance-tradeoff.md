...
The **bias–variance tradeoff** describes the balance between a model’s ability to capture patterns in training data and its ability to generalize to unseen data.
...
- **Regularization**: prevents overfitting (e.g., L1/L2 penalties).
- **Cross-validation**: estimate generalization error and tune complexity.
