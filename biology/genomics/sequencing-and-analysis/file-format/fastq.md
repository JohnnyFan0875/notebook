...
- Paired-end sequencing usually stores read 1 and read 2 in separate FASTQ files.
- The two files must stay synchronized so each pair can be aligned together.

## Quality Control

- [FastQC](../../../bioinformatics-tools/bioinformatics/fastqc.md): Quality control report generation

- [Fastp](../../../bioinformatics-tools/bioinformatics/fastp.md): Adapter trimming and filtering
