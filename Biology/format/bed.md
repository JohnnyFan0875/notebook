...
| Tool                                                                  | Purpose                          |
| --------------------------------------------------------------------- | -------------------------------- |
| [**bedtools**](../tools/bedtools.md)                                  | Manipulate and compare BED files |
| [**IGV**](../tools/igv.md)                                            | Visualize BED annotations        |
| [**samtools**](../tools/samtools.md)                                  | Filter BAM reads overlapping BED |
